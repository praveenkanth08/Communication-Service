...
export enum EmailTemplate {
  ...
  PRELIM_KYC_FAILURE = "PRELIM_KYC_FAILURE",
  SEND_OTP = "SEND_OTP",
  ...
  ONBOARDING_SUBMITTED_KYC_INTERNAL_AGENT = "ONBOARDING_SUBMITTED_KYC_INTERNAL_AGENT",
  ONBOARDING_NOTSTARTED_WELCOME_EMAIL = "ONBOARDING_NOTSTARTED_WELCOME_EMAIL",
  MSA_SOW_PREPARATION_REQUEST = "MSA_SOW_PREPARATION_REQUEST",
  MSA_SOW_UPLOAD_REQUEST = "MSA_SOW_UPLOAD_REQUEST",
}
